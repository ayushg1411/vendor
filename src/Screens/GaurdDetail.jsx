...
<button onClick={handleEdit} className='text-2xl font-normal text-gray-600 mt-2 px-16' ><MdOutlineAddPhotoAlternate/></button>
          ...
          <div className="px-32 py-8">
            <p className="py-2  text-sm">
              <span className="  py-2 text-sm font-bold">Phone:</span>{" "}
              {parking.mobile}
            </p>
            <p className="py-2  text-sm">
              ...
              {parking.associateParking}
            </p>
            <p className="py-2  text-sm">
              <span className="  py-2 text-sm font-bold">Email:</span>{" "}
              {parking.email}
            </p>
            <p className="py-2  text-sm">
              <span className="  py-2 text-sm font-bold">Address:</span>{" "}
              {parking.address}
            </p>
          </div>
        </div>
