...
const Parkings = () => {
  ...
  const viewParking=()=>{
    window.location.href="/parkingid"
  }
  // Sample parking data
  const parkingData = [
    {
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 ">
        {parkingData.map(parking => (
          ...
          >
            ...
            <img src={parking.photo} alt={parking.name} className="w-2/3 rounded-[40px] mx-auto h-40  object-cover object-center" />

            </div>
            <div className="py-3 px-2">
              <h2 className="text-xl font-semibold mb-1">{parking.name}</h2>
              <p className="text-gray-600 text-sm mb-1"><span className="font-bold">Area:</span> {parking.area}</p>
              <p className="text-gray-600 text-sm mb-1"><span className="font-bold">Date of Creation:</span> {parking.dateOfCreation}</p>
              <p className="text-gray-600 text-sm mb-1"><span className="font-bold">Price:</span> {parking.price}</p>
              <p className="text-gray-600 text-sm mb-1"><span className="font-bold">Guard Name:</span> {parking.guardName}</p>
              <p className="text-gray-600 text-sm mb-1"><span className="font-bold">Landmark:</span> {parking.landmark}</p>
            </div>
          </div>
        ))}
      </div>
